...
public class SHAHashOfFile {
    public static String hasFile(String file, String algorithm){
        String hashed = "";
        try {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("SHA-1\t: "+hasFile(file, "SHA-1"));
        System.out.println("SHA-256\t: "+hasFile(file, "SHA-256"));
        System.out.println("SHA-512\t: "+hasFile(file, "SHA-512"));
    }
}
